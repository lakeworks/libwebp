...
set(WEBP_SIMD_FLAGS "AVX512;AVX2;SSE41;SSE2;MIPS32;MIPS_DSP_R2;NEON;MSA")
set(WEBP_SIMD_FILE_EXTENSIONS
    "_avx512.c;_avx2.c;_sse41.c;_sse2.c;_mips32.c;_mips_dsp_r2.c;_neon.c;_msa.c")
if(MSVC AND CMAKE_C_COMPILER_ID STREQUAL "MSVC")
  ...
  if(MSVC_VERSION GREATER_EQUAL 1800 AND NOT CMAKE_C_FLAGS MATCHES "/arch:")
    set(SIMD_ENABLE_FLAGS "/arch:AVX512;;;;;;;")
  else()
    set(SIMD_ENABLE_FLAGS "/arch:AVX512;/arch:AVX2;/arch:AVX;/arch:SSE2;;;;")
  endif()
